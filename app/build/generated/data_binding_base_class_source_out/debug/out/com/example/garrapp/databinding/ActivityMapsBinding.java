...
public final class ActivityMapsBinding implements ViewBinding {
  ...
  @NonNull
  public final EditText searchMap;
  ...
  public static ActivityMapsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.searchMap;
      EditText searchMap = ViewBindings.findChildViewById(rootView, id);
      if (searchMap == null) {
        break missingId;
      }

      return new ActivityMapsBinding((ConstraintLayout) rootView, bottomNav, mapsLyt, searchMap);
    }
