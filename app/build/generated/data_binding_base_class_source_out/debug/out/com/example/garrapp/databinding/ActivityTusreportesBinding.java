...
public final class ActivityTusreportesBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ViewPager2 viewPagertusreportes;
  ...
  private ActivityTusreportesBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ViewPager2 viewPagertusreportes) {
  ...
  @NonNull
  public static ActivityTusreportesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTusreportesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_tusreportes, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTusreportesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ViewPager2 viewPagertusreportes = ViewBindings.findChildViewById(rootView, id);
      if (viewPagertusreportes == null) {
        break missingId;
      }

      return new ActivityTusreportesBinding((ConstraintLayout) rootView, barraSuperior, bottomNav,
          imageButton3, imageSalir, tabLayouttusreportes, textView, viewPagertusreportes);
    }
